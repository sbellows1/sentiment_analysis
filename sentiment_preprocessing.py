...
if __name__ == "__main__":
    ...
    ##This can be altered to decide if you would like to remove the neutral class
    df = df.loc[df['airline_sentiment'] != 'neutral',]

    train, test = train_test_split(df, test_size = .2, random_state = 42)

    ##This can be altered to balance the training set to have equal # of instances
    ##for the positive and negative class. From experimentation - this is NOT
    ...
    ##preprocess train and test sets by removing punc, stopwords, lemmatizing, etc.
    ...
    ##This removes words that occur less than 5 times and have a ratio below .002
    ...
    print(train_labels.loc[train_keep['text'].astype(str) == '[]'].value_counts())
